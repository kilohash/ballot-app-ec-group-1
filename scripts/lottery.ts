...
import { Lottery, LotteryToken, LotteryToken__factory } from "../typechain-types";
...
async function initContracts() {
  ...
  const tokenAddress = await contract.lotteryToken();
  const lotteryTokenFactory = new LotteryToken__factory();
  token = await lotteryTokenFactory.attach(tokenAddress);
